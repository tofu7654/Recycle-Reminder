...
#define buzzerPin 8 // Buzzer connected to digital pin 8
#define greenPin 7
...
{  
  ...
  LCD.print("Detecting Trash:");  //Print Message on First Row
}
...
void loop() {
  ...
  if (distance < 15) { // Change 15 to any threshold you want
     // Show warning message
    LCD.setCursor(0, 1);
    LCD.print("STOP, Recycle! ");
    digitalWrite(buzzerPin, HIGH);// Turn buzzer ON
    digitalWrite(greenPin, LOW); // Turn LED ON
  } 
  else {
